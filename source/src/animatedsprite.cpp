...
void AnimatedSprite::addAnimation(int frames, int x, int y, std::string name, int width, 
	int height, Vector2 offest) {
	...
	this->_offsets.insert(std::pair<std::string, Vector2>(name, offest));
}
